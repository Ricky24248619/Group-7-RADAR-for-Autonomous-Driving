...
> The sample uses under 1 GB locally. Physical radar translations remain unresolved
> and materially change the ground/raised ranking; this is a conditional support
> pilot, not detector accuracy. Download and no-devkit blockers have been overcome.
...
> **Historical status: blocked — no devkit existed.** Investigated 21 Aug 2026. The repository
